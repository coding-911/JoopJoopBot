...
DAG_FILE = "dart_weekly.py"

class TestDartWeeklyDag:
    ...
    def test_dag_structure(self):
        """DAG 구조 테스트"""
        dag = self.dagbag.get_dag(dag_id="dart_weekly")
    ...
    def test_dependencies(self):
        ...
        # get_listed_corps -> collect_weekly_disclosures
        collect_task = dag.get_task("collect_weekly_disclosures")
        assert dag.get_task("get_listed_corps").task_id in [
            task.task_id for task in collect_task.upstream_list
        ]
        
        # collect_weekly_disclosures -> process_documents
    ...
    def test_schedule_interval(self):
        ...
        assert dag.start_date <= days_ago(7)
    ...
    def test_document_processing(self, temp_db_session):
        ...
        test_documents = [{
            ...
            'report_type': '감사보고서',
            'title': '테스트 감사보고서',
            'content': '이 문서는 테스트를 위한 감사보고서입니다.',
        ...
        try:
            ...
            assert saved_report.title == '테스트 감사보고서'
